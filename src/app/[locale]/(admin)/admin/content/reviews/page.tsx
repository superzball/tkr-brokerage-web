...
import { ReviewsAdminClient } from "@/components/app/admin/ReviewsAdminClient";
import { getReviews } from "@/lib/mock/seed";

type Props = { params: Promise<{ locale: Locale }> };

export default async function ReviewsAdminPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <ReviewsAdminClient initial={getReviews()} />
    </>
  );
}
