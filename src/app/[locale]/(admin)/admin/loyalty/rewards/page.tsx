...
import { LoyaltyRewardsClient } from "@/components/app/admin/LoyaltyRewardsClient";
import { getAllRewards } from "@/lib/mock/seed";
...
export default async function LoyaltyRewardsPage({ params }: Props) {
  ...
  const t = await getTranslations("loyalty.admin.rewards");
  return (
    <>
      <PageHeader title={t("title")} description={t("desc")} />
      <LoyaltyRewardsClient initial={getAllRewards()} />
    </>
  );
}
